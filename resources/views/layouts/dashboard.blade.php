    ...
    <div class="flex min-h-screen">
        ...
        <aside 
            ...
            <nav class="space-y-3 flex-grow overflow-y-auto">
                ...
                <a href="{{ route('guide.index') }}" class="flex items-center gap-4 px-6 py-4 rounded-2xl {{ request()->routeIs('guide.*') ? 'bg-sky-blue text-dark-navy font-bold shadow-glow' : 'text-slate-500 dark:text-white/40 hover:text-sky-blue hover:bg-sky-blue/10' }} transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
