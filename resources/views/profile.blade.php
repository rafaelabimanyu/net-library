...
@section('title', 'Control Center | Net-Library Profile')

@section('content')
<main class="max-w-7xl mx-auto px-10 py-10">
    <header class="mb-20">
        <h2 class="text-5xl font-black tracking-tighter mb-4 text-dark-navy dark:text-white transition-colors duration-300">Identity Control</h2>
        <p class="text-gray-400 dark:text-white/30 font-light text-lg">Manage your neural presence and security protocols.</p>
    </header>
            ...
            <div class="bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-sky-blue/20 dark:border-white/10 rounded-[3rem] p-12">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-white/20 mb-3 block">Full Identity</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-white/20 mb-3 block">Neural Email</label>
            ...
            <div class="bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-sky-blue/20 dark:border-white/10 rounded-[3rem] p-12">
                ...
                <form action="{{ route('profile.password') }}" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <label class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-white/20 mb-3 block">Current Password</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-white/20 mb-3 block">New Cipher</label>
                        ...
                        <div>
                            <label class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-white/20 mb-3 block">Confirm Cipher</label>
