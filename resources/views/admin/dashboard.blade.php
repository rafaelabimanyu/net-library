...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-16">
    <div class="lg:col-span-1 bg-white dark:bg-white/10 border border-slate-200 dark:border-white/20 shadow-sm rounded-[2.5rem] p-8 transition-all duration-500 hover:shadow-md">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    <div class="lg:col-span-2 bg-white dark:bg-white/10 border border-slate-200 dark:border-white/20 shadow-sm rounded-[3rem] p-10">
