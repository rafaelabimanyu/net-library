        ...
        <table class="w-full text-left">
            <thead>
                <tr class="bg-slate-50 dark:bg-white/5">
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 dark:text-white/20">Asset</th>
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 dark:text-white/20">Category</th>
                    <th class="px-10 py-6 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 dark:text-white/20">Stock Status</th>
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-white/2 transition-colors">
                    <td class="px-10 py-8">
                        <p class="font-black text-lg tracking-tight text-slate-800 dark:text-white">{{ $book->judul }}</p>
                        <p class="text-xs text-slate-500 dark:text-white/30 font-light">{{ $book->penulis }}</p>
                    </td>
                    <td class="px-10 py-8">
                    ...
                    <td class="px-10 py-8">
                        <div class="flex items-center gap-3">
                            <div class="flex-grow bg-slate-100 dark:bg-white/5 h-1.5 w-24 rounded-full overflow-hidden">
                                <div class="h-full bg-sky-blue shadow-glow" style="width: {{ ($book->stok_tersedia / $book->stok_total) * 100 }}%"></div>
                            </div>
                    ...
                    <td class="px-10 py-8">
                        <div class="flex gap-4">
                            ...
                            <button class="text-red-500/40 hover:text-red-500 transition-all text-[10px] font-black uppercase tracking-widest">Delete</button>
                        </div>
                    </td>
                </tr>
                @endforeach
